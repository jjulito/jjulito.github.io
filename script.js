...
const translations = {
    es: {
        ...
        "description-2": "Los proyectos están hosteados en servicios gratuitos (Render, GitHub Pages). Es posible que la primera carga tome hasta 5 minutos debido a políticas de suspensión por inactividad. Si experimentas demoras, por favor espera unos minutos y recarga la página.",
    ...
    en: {
        ...
        "description-2": "IMPORTANT: Projects are hosted on free-tier services (Render, GitHub Pages). Initial loading may take up to 5 minutes due to inactivity suspension policies. If you experience delays, please wait a few minutes and refresh the page.",
